...
if __name__ == "__main__":
    ...
    result_1.to_csv("task_1/predictions/agoda_cancellation_prediction.csv", index=False)
    ...
    result_2.to_csv("task_1/predictions/agoda_cost_of_cancellation.csv", index=False)
